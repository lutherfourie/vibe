...
export const AutonomousSessionSchema = z.object({
    ...
    const hasQualityStep = data.lanes.some(lane => lane.steps.some(step => step.type === "self-review" || step.type === "research"));
    if (!hasQualityStep) {
...
export const parseResolverOutput = (raw) => {
